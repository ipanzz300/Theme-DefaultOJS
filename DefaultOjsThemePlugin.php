...
/**
 * @file plugins/themes/default/DefaultOjsThemePlugin.php
 *
...
namespace APP\plugins\themes\defaultOjs;
...
class DefaultOjsThemePlugin extends \PKP\plugins\ThemePlugin
{
    ...
    public function init()
    {
        ...
        $this->addOption('typography', 'FieldOptions', [
            'type' => 'radio',
            'label' => __('plugins.themes.defaultOjs.option.typography.label'),
            'description' => __('plugins.themes.defaultOjs.option.typography.description'),
            'options' => [
                [
                    'value' => 'notoSans',
                    'label' => __('plugins.themes.defaultOjs.option.typography.notoSans'),
                ],
                [
                    'value' => 'notoSerif',
                    'label' => __('plugins.themes.defaultOjs.option.typography.notoSerif'),
                ],
                [
                    'value' => 'notoSerif_notoSans',
                    'label' => __('plugins.themes.defaultOjs.option.typography.notoSerif_notoSans'),
                ],
                [
                    'value' => 'notoSans_notoSerif',
                    'label' => __('plugins.themes.defaultOjs.option.typography.notoSans_notoSerif'),
                ],
                [
                    'value' => 'lato',
                    'label' => __('plugins.themes.defaultOjs.option.typography.lato'),
                ],
                [
                    'value' => 'lora',
                    'label' => __('plugins.themes.defaultOjs.option.typography.lora'),
                ],
                [
                    'value' => 'lora_openSans',
                    'label' => __('plugins.themes.defaultOjs.option.typography.lora_openSans'),
                ],
            ],
            'default' => 'notoSans',
        ]);
        ...
        $this->addOption('baseColour', 'FieldColor', [
            'label' => __('plugins.themes.defaultOjs.option.colour.label'),
            'description' => __('plugins.themes.defaultOjs.option.colour.description'),
            'default' => '#1E6292',
        ]);
        ...
        $this->addOption('showDescriptionInJournalIndex', 'FieldOptions', [
            ...
            'options' => [
                [
                    'value' => true,
                    'label' => __('plugins.themes.defaultOjs.option.showDescriptionInJournalIndex.option'),
                ],
            ],
            'default' => false,
        ]);
        $this->addOption('useHomepageImageAsHeader', 'FieldOptions', [
            'label' => __('plugins.themes.defaultOjs.option.useHomepageImageAsHeader.label'),
            'description' => __('plugins.themes.defaultOjs.option.useHomepageImageAsHeader.description'),
            'options' => [
                [
                    'value' => true,
                    'label' => __('plugins.themes.defaultOjs.option.useHomepageImageAsHeader.option')
                ],
            ],
            'default' => false,
        ]);
        $this->addOption('displayStats', 'FieldOptions', [
            'type' => 'radio',
            'label' => __('plugins.themes.defaultOjs.option.displayStats.label'),
            'options' => [
                [
                    'value' => 'none',
                    'label' => __('plugins.themes.defaultOjs.option.displayStats.none'),
                ],
                [
                    'value' => 'bar',
                    'label' => __('plugins.themes.defaultOjs.option.displayStats.bar'),
                ],
                [
                    'value' => 'line',
                    'label' => __('plugins.themes.defaultOjs.option.displayStats.line'),
                ],
            ],
            'default' => 'none',
        ]);
    ...
    {
        return __('plugins.themes.defaultOjs.name');
    }
    ...
    {
        return __('plugins.themes.defaultOjs.description');
    }
}

if (!PKP_STRICT_MODE) {
    class_alias('\APP\plugins\themes\defaultOjs\DefaultOjsThemePlugin', '\DefaultOjsThemePlugin');
}
